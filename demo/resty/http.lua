...
function _M.tcp_only_connect(self, ...)
    print("Use of deprecated `connect` method signature")
        ...
        if not content_length and max_chunk_size then
            ...
            repeat
                ...
                if not max_chunk_size then
                    print("Buffer size not specified, bailing")
                    break
                end
            until not str
...
function _M.ssl_handshake(self, ...)
    print("Use of deprecated function `ssl_handshake`")
...
function _M.connect_proxy(self, proxy_uri, scheme, host, port, proxy_authorization)
    print("Use of deprecated function `connect_proxy`")
...
function _M.proxy_request(self, chunksize)
    print("Use of deprecated function `proxy_request`")
...
function _M.proxy_response(_, response, chunksize)
    print("Use of deprecated function `proxy_response`")
